...
Bien que les résidus déclarés par ces mines contiennent de grandes quantités de manganèse, d’ammoniac (NH₃) et de phosphore, ce sont certains composés organiques volatils, comme le benzène (C<sub>6</sub>H<sub>6</sub>), le toluène (C<sub>7</sub>H<sub>8</sub>), l’éthylbenzène (C<sub>8</sub>H<sub>10</sub>) et le xylène (C<sub>8</sub>H<sub>10</sub>) (désignés BTEX sur la figure) et 19 différents hydrocarbures aromatiques polycycliques (HAP) qui sont les plus préoccupants.`,
                    type: 'text'
                },
                {
...
- Benzène (C<sub>6</sub>H<sub>6</sub>);
