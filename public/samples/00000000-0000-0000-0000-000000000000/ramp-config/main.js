        ...
        en: {
            ...
            layers: [
                ...
                },
                {
                    ...
                    layerType: 'ogc-wfs',
                    url:
                        'https://api.weather.gc.ca//collections/ahccd-trends/items?measurement_type__type_mesure=total_precip&period__periode=Ann&startindex=0&limit=1000&province__province=on',
                    xyInAttribs: true,
                    colour: '#FF5555',
                    state: {
                        visibility: true
                ...
                },
                {
                    ...
                    layerType: 'esri-feature',
                    url:
                        'https://maps-cartes.ec.gc.ca/arcgis/rest/services/2015_Disturbance_Footprints_Boreal_Caribou_lempreinte_15m/MapServer/0',
                    mouseTolerance: 5,
                    identifyMode: 'hybrid',
                    state: {
                        opacity: 0.5,
                ...
                },
                {
                    ...
                    layerType: 'esri-feature',
                    url:
                        'https://maps-cartes.ec.gc.ca/arcgis/rest/services/StoryRAMP/410b88da_0ed1_4749_903f_5e76c24e2e5f/MapServer/1',
                    state: {
                        opacity: 1,
                        visibility: false
                    },
                ...
                },
                {
                    ...
                    layerType: 'esri-feature',
                    url:
                        'https://maps-cartes.ec.gc.ca/arcgis/rest/services/StoryRAMP/410b88da_0ed1_4749_903f_5e76c24e2e5f/MapServer/2',
                    state: {
                        opacity: 1,
                        visibility: false
                    },
                                ...
                                children: [
                                    {
                                        ...
                                        children: [
                                            ...
                                            {
                                                name:
                                                    'Surprise 2: Secret feature layer hidden in info section with custom cover icon',
                                                layerId: 'Caribous',
